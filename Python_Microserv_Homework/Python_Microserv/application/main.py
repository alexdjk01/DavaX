...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # or specific at 5500/8000: ["http://127.0.0.1:5500"]
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)
# Middleware for console logging in terminal
app.add_middleware(LoggingMiddleware)
# SQLite database instance for persistance locally
init_db()
# Multiple routers for endpoints
...
# root home path that displays a log message -> application is running
@app.get("/")
def read_root():
